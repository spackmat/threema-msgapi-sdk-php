...
class CryptToolTest extends TestCase
{
    ...
    public function testEncrypt()
    {
        ...
        $this->doTest(function (CryptTool $cryptTool, $prefix) {
            ...
            $box = $cryptTool->decryptMessage($message,
                $cryptTool->hex2bin(KeyPrefix::removePrivate(TestConstants::otherPrivateKey)),
                $cryptTool->hex2bin(KeyPrefix::removePublic(TestConstants::myPublicKey)),
                $cryptTool->hex2bin($nonce));
    ...
    {
        $this->doTest(function (CryptTool $cryptTool, $prefix) {
            $publicKey   = $cryptTool->derivePublicKey($cryptTool->hex2bin(KeyPrefix::removePrivate(TestConstants::myPrivateKey)));
            $myPublicKey = $cryptTool->hex2bin(KeyPrefix::removePublic(TestConstants::myPublicKey));
    ...
    public function testEncryptImage()
    {
        ...
        $this->doTest(function (CryptTool $cryptTool, $prefix) use ($threemaIconContent) {
            $privateKey = $cryptTool->hex2bin(KeyPrefix::removePrivate(TestConstants::myPrivateKey));
            $publicKey  = $cryptTool->hex2bin(KeyPrefix::removePublic(TestConstants::myPublicKey));

            $otherPrivateKey = $cryptTool->hex2bin(KeyPrefix::removePrivate(TestConstants::otherPrivateKey));
            $otherPublicKey  = $cryptTool->hex2bin(KeyPrefix::removePublic(TestConstants::otherPublicKey));
